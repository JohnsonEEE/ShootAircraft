...
class GIFImage(object):
    def __init__(self, filename, max_play_round):
        ...
        self.played_round = 0
        self.max_play_round = max_play_round
        self.over = False
    ...
    def render(self, screen, pos):
        if self.running and self.over is False:
            if time.time() - self.ptime > self.frames[self.cur][1]:
                ...
                if self.played_round >= self.max_play_round:
                    self.over = True
...
def main():
    ...
    hulk = GIFImage("images/giphy.gif", 4)
